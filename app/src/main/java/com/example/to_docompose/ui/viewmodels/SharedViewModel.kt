...
class SharedViewModel @Inject constructor(
    // 이렇게 하면 뷰모델 안에서 따로 repo를 초기화하지 않고
    // 바로 받아서 사용할 수 있음
    private val repository: ToDoRepository, // todd_repo inject
    private val dataStoreRepository: DataStoreRepository // database repo inject
) : ViewModel() {
